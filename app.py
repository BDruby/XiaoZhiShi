...
def create_app():
    ...
    def inject_navigations():
        navigations = Navigation.query.filter_by(is_active=True).order_by(Navigation.position.asc()).all()
        return dict(active_navigations=navigations)
